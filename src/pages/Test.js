...
const Test = () => {
  ...
  useEffect(()=>{
    ...
    setInputs(prev => ({...prev, 'dish_image': ' '}));
    setInputs(prev => ({...prev, 'tray_image': ' '}));
    // console.log(state['Info']['DishImage'])
  ...
  }, [state, updateSlots, setPreviewDish, setPreviewTray]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dish_info = {
        ...
        // "Dishfolder": state['Info']['Dishfolder'],
        // "DishImage": state['Info']['DishImage'],
        ...
        // "Region": [],
        // "ReviewCount": "0",
        "TrayImage": state['Info']['TrayImage'],
        "Type": inputs["Type"],
    ...
    for (let i =0; i < slots.length; i++) {
      ...
      const dish_recipe = {
        ...
        "PrepTime": inputs["PrepTime"],
        "Quantity": "0",
        // "Recipefile": state['Recipe']['Recipefile'],
      ...
      await fetch("https://a5morsuyy6.execute-api.ap-south-1.amazonaws.com/dev/test",
      {
          method: "PATCH",
    ...
    <div className='container'>
      <form onSubmit={handleSubmit} className='form'>
        ...
        <div className='file-input'>
          ...
          <FileInput name="recipe_file" label="Recipe File" required={false} onchange={handleFileSelect}/>
        </div>
